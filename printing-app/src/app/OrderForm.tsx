...
export default function OrderForm() {
  ...
  const optionFields = (
    <>
      <div>
        <span className="block text-sm font-medium text-zinc-700 mb-2">Sides</span>
      ...
      <div>
        <span className="block text-sm font-medium text-zinc-700 mb-2">Color</span>
        <div className="flex gap-3">
          {[
      ...
      <div>
        <label className="block text-sm font-medium text-zinc-700 mb-2" htmlFor="copies">
          Number of copies
        </label>
        <input
          id="copies"
    ...
    return (
      <div className="space-y-6">
        <div className="rounded-xl border border-zinc-200 bg-white p-6 space-y-4">
          <h2 className="text-lg font-semibold text-zinc-900">Review your order</h2>
          <dl className="grid grid-cols-2 gap-y-2 text-sm">
            <dt className="text-zinc-500">File</dt>
            <dd className="text-zinc-900">{file?.name}</dd>
            <dt className="text-zinc-500">Pages detected</dt>
            <dd className="text-zinc-900">{quote.pages}</dd>
            <dt className="text-zinc-500">Sides</dt>
            <dd className="text-zinc-900">{duplex ? "Double-sided" : "Single-sided"}</dd>
            <dt className="text-zinc-500">Color</dt>
            <dd className="text-zinc-900">{color ? "Color" : "Black & White"}</dd>
            <dt className="text-zinc-500">Copies</dt>
            <dd className="text-zinc-900">{copies}</dd>
          </dl>
          <div className="border-t border-zinc-200 pt-4 flex items-baseline justify-between">
            ...
            <span className="text-2xl font-bold text-zinc-900">{money(quote.totalPrice)}</span>
          </div>
  ...
  return (
    <form onSubmit={handleGetPrice} className="space-y-6">
      <div>
        <label className="block text-sm font-medium text-zinc-700 mb-2" htmlFor="file">
        ...
        />
        <p className="mt-1 text-xs text-zinc-500">PDF, JPG, PNG or WEBP, up to 30MB.</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          <label className="block text-sm font-medium text-zinc-700 mb-2" htmlFor="customerName">
            Your name
          </label>
          <input
            id="customerName"
        ...
        <div>
          <label className="block text-sm font-medium text-zinc-700 mb-2" htmlFor="customerPhone">
            Phone number
          </label>
          <input
            id="customerPhone"
      ...
      <div>
        <label className="block text-sm font-medium text-zinc-700 mb-2" htmlFor="notes">
          Notes (optional)
        </label>
        <textarea
          id="notes"
